    ...
    for dependency in dependencies:
        ...
        if frozen_version != latest_version:
            if "git+https://" not in frozen_version:
                report_production_dependencies.append((f"{dependency} {frozen_version} -> {latest_version}", 'bright_yellow'))
            else:
                report_production_dependencies.append((f"{dependency} {frozen_version} -> {latest_version}", 'bright_red'))
        else:
